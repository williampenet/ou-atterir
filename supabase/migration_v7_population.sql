-- =====================
-- Migration V7: Population column + population size filter
-- =====================

-- 1. Add population column
...
-- 2. Drop old RPC signatures to avoid overload ambiguity (HTTP 300)
DROP FUNCTION IF EXISTS search_communes(text, text, text, text[], int, int);
DROP FUNCTION IF EXISTS count_communes(text, text, text, text[]);

-- 3. Recreate search_communes with target_pop_ranges
...
-- 4. Recreate count_communes with target_pop_ranges
