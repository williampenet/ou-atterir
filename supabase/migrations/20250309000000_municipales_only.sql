-- ==========================================================
-- Ou Atterir — Restrict political orientation to municipales only
-- Non-municipales elections are kept in the DB but excluded
-- from the forteresse/tendance classification logic.
-- ==========================================================

BEGIN;

-- ==========================================================
-- 1. Replace search_communes — filter commune_stats to municipales
-- ==========================================================
...
-- ==========================================================
-- 2. Replace count_communes — filter commune_stats to municipales
-- ==========================================================
