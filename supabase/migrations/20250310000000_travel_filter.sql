-- ==========================================================
-- Ou Atterir — Travel time filter support
-- Adds target_insee_list parameter to search_communes and
-- count_communes RPCs for spatial filtering via isochrone.
-- ==========================================================

BEGIN;

-- ==========================================================
-- 1. Replace search_communes — add target_insee_list
-- ==========================================================
...
-- ==========================================================
-- 2. Replace count_communes — add target_insee_list
-- ==========================================================
