-- ==========================================================
-- Ou Atterir — Bounds filter support
-- Adds lat/lng bounds parameters to search_communes and
-- count_communes RPCs for map-driven spatial filtering.
-- ==========================================================

BEGIN;

-- ==========================================================
-- 1. Replace search_communes — add bounds params
-- ==========================================================

DROP FUNCTION IF EXISTS search_communes(text, text, text, text[], text[], text, text[], int, text, text[], int, int);
...
-- ==========================================================
-- 2. Replace count_communes — add bounds params
-- ==========================================================

DROP FUNCTION IF EXISTS count_communes(text, text, text, text[], text[], text, text[], int, text, text[]);
...
-- ==========================================================
-- 3. Index on lat/lng for bounds filtering
-- ==========================================================
